  ...
  module Build
    class Script
      class Python < Script
        ...
        def install
          self.if_file_exists   'Requirements.txt', "pip install -r Requirements.txt", fold: 'install', retry: true
          self.elif_file_exists 'requirements.txt', "pip install -r requirements.txt", fold: 'install', retry: true
